                    ...
                    <div className='formStepOne py-md-5 py-4 m-auto mt-3 px-3 rounded-3 '>
                        ...
                        <div className='inputForm d-flex align-items-center justify-content-between py-3'>
                            ...
                            <input
                                ...
                                type="text" placeholder='Best time to clean' />
                        </div>
                        ...
                        <div className='serviceSpace'>
                            <div className='Space-types-card d-flex align-items-center justify-content-center flex-column'>
                                ...
                                <img className='py-4' src="/images/servicesForm/kitchen.png" alt="kitchen" />
                                <div className='yes-no-but-group mt-4 text-center'>
                                    <button
                            ...
                            <div className='Space-types-card d-flex align-items-center justify-content-center flex-column'>
                                ...
                                <img className='py-4' src="/images/servicesForm/Storage_Locker.png" alt="Storage_Locker" />
                                <div className='yes-no-but-group mt-4 text-center'>
                                    <button
