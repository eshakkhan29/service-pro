          ...
          <div className="formStepOne py-md-5 py-4 m-auto mt-3 px-3 rounded-3">
            ...
            <div className="inputForm py-3">
              ...
              <input
                ...
                className="w-100"
                type="text"
                placeholder="Enter the square footage for the total area that requires disinfection."
              />
            </div>
            <div className="inputForm d-flex align-items-center justify-content-between py-3">
              <p className="m-0">Total number of people in the office?</p>
              <select
            ...
            <div className="serviceSpace">
              ...
              <FormSpaceType
                ...
                toolTip={
                  "This is the number of work station or cubicles or desks.   Do not include the ENCLOSED office spaces indicated in the previous question.  A cubicle or work station is a seating location for any that is used regularly."
                }
              ...
              <FormSpaceType
                title={"Hallways"}
                toolTip={
                  "To calculate the # of Hallways, we measure 1 unit as equivalent to maximum of 250 square of space.  Hence if you have 1 large hallway of 500 sq ft, select 2 units for this hallway.   Give it your best guesstimate.  We'll confirm and update it during our site visit."
                }
