...
const SchoolCleaningForm = () => {
    ...
    const fullData = {
        ...
        space_types: { officesSpaces, meetingRooms, bathrooms, cafeterias, gymLocker, lounging, reception, officeStorage, toiletStalls }
    }
                    ...
                    <div className='formStepOne py-2 m-auto mt-3 bg-white px-3 rounded-3 shadow-sm'>
                        ...
                        <div className='serviceSpace'>
                            ...
                            <FormSpaceType
                                ...
                                toolTip={"What is the estimated total number of stalls and urinals at the school?"}
