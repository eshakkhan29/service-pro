    ...
    return (
        <div className='container p-lg-0 d-flex flex-column flex-lg-row justify-content-between gap-4 mb-5'>
            <div className='aboutDetails w-100'>
                ...
                <p>To lead the commercial cleaning industry by providing the highest level of customer service and quality of work. Our goal is to delight each and every one of our clients by meeting their specific cleaning requirements using our stringent operating standards.</p>
            </div>
            <div className='aboutDetails w-100'>
                <h2 className='sub-heading'>Our Mission</h2>
                <p>To provide first-class cleaning and maintenance services through an unparalleled level of professionalism, supported by a flexible online and offline approach.</p>
            </div>
            <div className='aboutDetails w-100'>
